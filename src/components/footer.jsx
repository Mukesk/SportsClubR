    ...
    <footer className="footer ">
      <div className="footer-container">
        <div className="footer-section about">
          ...
          <p>We are a passionate sports club dedicated to promoting healthy lifestyles and competitive spirit. Join us for the latest events, updates, and news.</p>
        </div>
    ...
    <svg viewBox="0 0 16 16" class="socialSvg whatsappSvg">
      ...
      ></path>
        ...
        <div className="footer-section contact">
          ...
          <p><i className="fas fa-envelope"></i> info@sportsclub.com</p>
        </div>
      </div>
      <div className="footer-bottom">
        &copy; {new Date().getFullYear()} SportsClub | All Rights Reserved
      </div>
    </footer>
  );
};
